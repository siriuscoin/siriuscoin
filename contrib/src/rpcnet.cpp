...
Value makekeypair(const Array& params, bool fHelp)
{
    ...
    result.push_back(Pair("PrivateKey", CSiriuscoinSecret(vchSecret, fCompressed).ToString()));
    return result;
}
...
Value sendalert(const Array& params, bool fHelp)
{
    ...
    if (!key.Sign(HashSHA3(alert.vchMsg.begin(), alert.vchMsg.end()), alert.vchSig))
        throw runtime_error(
