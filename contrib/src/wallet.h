...
#ifndef SIRIUSCOIN_WALLET_H
#define SIRIUSCOIN_WALLET_H
...
enum WalletFeature
{
    ...
    FEATURE_WALLETCRYPT = 100, // wallet encryption
    FEATURE_COMPRPUBKEY = 100, // compressed public keys
...
public:
	...
	std::string StoreData(CWalletTx& wtxNew, bool fAskFee, const std::string& txData);
