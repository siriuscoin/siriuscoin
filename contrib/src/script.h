...
#ifndef H_SIRIUSCOIN_SCRIPT
#define H_SIRIUSCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CSiriuscoinAddress
 */
...
public:
    ...
    // Siriuscoin always counted CHECKMULTISIGs
