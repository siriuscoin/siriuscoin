...
static const CSiriuscoinAddress addr1 ("SQFqqMUD55ZV3PJEJZtaKCsQmjLT6JkjvJ");
static const CSiriuscoinAddress addr2 ("SF5y5E5FMc5YzdJtB9hLaUe43GDxEKXENJ");
static const CSiriuscoinAddress addr1C("SNoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
static const CSiriuscoinAddress addr2C("SCRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CSiriuscoinAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CSiriuscoinSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
