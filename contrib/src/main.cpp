...
uint256 hashGenesisBlock("0x0008f9ed5d8f654637f711dedf697dd84cec1fc20a3c122a68b9993690e66726");
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uSSC
...
//	Subsidy is cut in half every 1,000,000,000 blocks, which will occur approximately every 38+ years
//	nSubsidy >>= (nHeight / 1000000000);
...
//		}
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0x8503eee9c2505df18ab3f4b59135cc1bea0a5d0a7d1653c4da0d4bc2f03553c8"));
